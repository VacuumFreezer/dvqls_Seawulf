...
DEFAULT_STATIC_OPS = (
    ...
    "Partition_comparison_qjit/2b2/static_ops_cluster13_real_2x2.py",
    "Partition_comparison_qjit/4b4/static_ops_cluster13_real_4x4.py",
    "Partition_comparison_qjit/8b8/static_ops_cluster13_real_8x8.py",
)
...
def main(argv=None):
    ...
    ap.add_argument("--out", default="Partition_comparison_qjit/verification_report.json")
