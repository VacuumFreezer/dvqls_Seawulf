...
TARGET_LAMBDA_MIN = 1.0 / 200.0

N_INDEX_QUBITS = 2
N_DATA_QUBITS_4X4 = 5
N_TOTAL_QUBITS = N_INDEX_QUBITS + N_DATA_QUBITS_4X4  # 7
N_AGENTS_4X4 = 4
...
def _build_4x4_system() -> Tuple[LinearSystemData, list, list, list]:
    ...
    metadata = {
        "benchmark_name": "ising_4x4_5q_cond200",
