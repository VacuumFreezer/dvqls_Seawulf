...
OPTIMIZE_SCRIPT = THIS_DIR / "formal_compare_mps_optimize.py"
DEFAULT_CONFIG = THIS_DIR / "param.yaml"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one prepared formal-vs-MPS comparison case and collect artifacts in one output directory."
    )
