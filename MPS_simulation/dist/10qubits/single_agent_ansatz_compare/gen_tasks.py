...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate prepared Seawulf task files for the 13-qubit single-agent ansatz comparison."
    )
...
def main() -> None:
    ...
    for case_name in case_order:
        ...
        cmd_parts = [
            "python",
            "MPS_simulation/dist/10qubits/single_agent_ansatz_compare/run_single_agent_case.py",
            "--config",
    ...
    print(
        ...
        "MPS_simulation/dist/10qubits/single_agent_ansatz_compare/submit_array.slurm"
    )
