...
OPTIMIZE_SCRIPT = THIS_DIR / "partition_compare_optimize.py"
DEFAULT_CONFIG = THIS_DIR / "param.yaml"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run one prepared partition-comparison case and collect artifacts in a single output directory."
    )
...
def main() -> None:
    ...
    if args.init_mode is not None:
        cmd.extend(["--init-mode", args.init_mode])
