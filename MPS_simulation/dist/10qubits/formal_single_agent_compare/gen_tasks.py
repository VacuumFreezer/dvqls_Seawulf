...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate prepared Seawulf task files for the formal-style single-agent MPS comparison."
    )
...
def main() -> None:
    ...
    for case_name in case_order:
        ...
        cmd_parts = [
            "python",
            "MPS_simulation/dist/10qubits/formal_single_agent_compare/formal_single_agent_optimize.py",
            "--config",
    ...
    print(
        ...
        "MPS_simulation/dist/10qubits/formal_single_agent_compare/submit_array.slurm"
    )
