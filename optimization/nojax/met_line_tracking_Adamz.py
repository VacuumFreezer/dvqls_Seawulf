...
def main():
    ...
    opt_adam = qml.AdamOptimizer(stepsize=args.lr_a)                 # beta/lambda
    opt_gd   = qml.GradientDescentOptimizer(stepsize=args.lr_g)      # alpha/sigma
