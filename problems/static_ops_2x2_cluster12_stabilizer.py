...
Design goals
------------
- physical-inspired: truncated cluster Hamiltonian / stabilizer Hamiltonian;
- sparse Pauli expansion: 1 identity + 4 stabilizers + 1 single-qubit perturbation;
- exact solution real and close to |b>, but not proportional to |b>;
- spectral range fixed at [1/50, 1].

As in the previous 2x2 reduction, we choose global qubit 2 as the block index.
Then K_2 and X_2 become off-diagonal block terms and the other 3 stabilizers stay diagonal.
"""
...
SYSTEM_2X2 = LinearSystemData(
    ...
    name="cluster12_stabilizer_2x2_q2_index",
    metadata={
